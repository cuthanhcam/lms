        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Enrollments_ProgressPercentage", "ProgressPercentage >= 0 AND ProgressPercentage <= 100");
                    table.CheckConstraint("CK_Enrollments_Status", "Status IN (0, 1, 2)");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Lessons_Order", "[Order] > 0");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Courses_IsPublished_IsDeleted",
                table: "Courses",
